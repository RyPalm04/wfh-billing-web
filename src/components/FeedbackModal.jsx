            ...
            <div className="modal" onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-field">
                        ...
                        <textarea id="feedbackDescription" value={description} onChange={e => setDescription(e.target.value)} rows={5} placeholder="Describe the issue or idea..." required />
                    </div>
                    <div className="modal-actions">
                        <button type="button" className="btn btn-secondary" onClick={onClose}>Cancel</button>
                        <button type="button" className="btn btn-primary" disabled={submitting || !description.trim()}>
